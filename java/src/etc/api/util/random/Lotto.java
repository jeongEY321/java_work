...
public class Lotto {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(count == 6) {
				System.out.println("1등 당첨입니다."); prize1++; break;
			} if(count == 5) {
				if(lottoP == playLP) {
					System.out.println("2등 당첨입니다."); prize2++;
				} else {
					System.out.println("3등 당첨입니다."); prize3++;
				}
			} if(count == 4) {
				System.out.println("4등 당첨입니다."); prize4++;
			} if(count == 3) {
				System.out.println("5등 당첨입니다."); prize5++;
			} if(count < 3) {
				System.out.println("꽝 입니다."); failCnt++;
			} countCash++;
