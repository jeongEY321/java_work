...
public class Identifier {
	...
	public static void main(String[] args) {
		...
		//꼭 지켜야 할 규칙 (안 지킬 시 에러가 발생할 수 있다)
...
//		int my birth day = 1999204; (x)
		int mybirthday = 19990204;
		int myBirthDay = 1999204; //camel case
		
		//4. 식별자 이름에 쓸 수 있는 특수문자는 밑줄(_), 달러기호($)
		//뿐이다. 하지만 사용을 권장하지는 않는다.
