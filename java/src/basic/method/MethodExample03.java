...
public class MethodExample03 {
	...
	public static void main(String[] args) {
		...
		int r1 = add(3, 8); // int ri = 11;
		int r2 = add(10, 15); //int r2 = 25;
		int r3 = add(add(6, 4), add(7, 8));
		...
		int[] num = {57, 89, 78, 91, 93, 47};
		calcArrayTotal(num);
		System.out.println("--------------------------");
		System.out.printf("합계: %s\t평균: %.2f\n", calcArrayTotal(num), (calcArrayTotal(num)/(double)num.length));
