...
public class MethodQuuiz02 {

	static String[] foods = {"떠볶이", "치킨", "파스타"};

	//배열의 맨 마지막 위치에 데이터를 추가하는 함수
	//기존 배열보다 크기가 하나 큰 배열 선어해서 값 그대로 내리기
	//매개값으로 온 값을 마지막에 채우기.
	...
	static void remove(String targetName) {
		...
		if(idx == -1) {
			System.out.println("존재하지 않은 음식명입니다.");
		}else {
