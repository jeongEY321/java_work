...
public class Point {
	...
	public void inputPoints(List<Student> stu) {
		Student s = new Student();
		stu.add(s);
		System.out.println(s.getName() + "님의 정보가 정상적으로 입력되었습니다.");
	...
	public void showAllPoints(List<Student> stu) { //학생 객체들이 들어있는 리스트가 와야죠?
		for(Student s : stu) {
			showPointUI();
			s.outputStuInfo();
		}
	...
	public void modifyPoint(List<Student> students) {
		 ...
		 */
		System.out.println("성적정보를 수정할 학생의 학번을 입력하세요.");
		System.out.print("> ");
		String stuNum = sc.next();
	...
	public void deletePoint(List<Student> students) {
		...
		System.out.println("모든 정보를 삭제할 학생의 학번을 입력하세요.");
		System.out.print("> ");
		String stuNum = sc.next();
